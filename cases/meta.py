...
from anonimization_script.utils import DBFactory
...
class MetaCase(Meta):
    """Meta class for Case"""
    def __init__(self, dbs: Dict[str, DBAdapter], rules: dict):
        self._dbs = dbs
        self._rules = rules
    ...
    @classmethod
    def from_case_config(cls, config: dict) -> Meta:
        ...
        return cls(dbs=dbs, rules=rules)
